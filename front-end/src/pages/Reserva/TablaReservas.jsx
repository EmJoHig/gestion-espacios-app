...
function EnhancedTableToolbar(props) {
  const { numSelected, handleReservasSelected, esAdministrador } = props;
        ...
        <Tooltip title="Dar de Baja">
          <Box sx={{ display: 'flex', gap: 2 }}> {/* Contenedor flex con espacio entre botones */}
            <Button
              color="error"
              variant="contained"
              onClick={() => handleReservasSelected()}
            >
              DAR DE BAJA
            </Button>
          </Box>
...
export default function EnhancedTable({ data, columnasTabla, onReservasSelected }) {
  ...
  const handleReservasSelected = () => {
    // Enviar los ids seleccionados al padre
    onReservasSelected(selected); // Enviamos el array de ids seleccionados
    setSelected([]);
  };
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        {/* <EnhancedTableToolbar numSelected={selected.length} handleReservasSelected={handleReservasSelected} /> */}
        <EnhancedTableToolbar
          numSelected={selected.length}
          handleReservasSelected={handleReservasSelected}
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">{row.Actividad.nombre}</TableCell>
                    ...
                    <TableCell align="center">{row.fechaBaja ? format(new Date(row.fechaFin), 'dd/MM/yyyy HH:mm') : '-'}</TableCell>
